...
VLC_PORT = 9090
VLC_COMMAND = '--qt-start-minimized --fullscreen --extraintf=luahttp --http-host=localhost --http-port=%s --sout-ffmpeg-strict=-2 --avi-index=2 --no-qt-error-dialogs --no-qt-privacy-ask' % VLC_PORT
...
if sys.platform.startswith('win32'): #Windows
    ...
    try:
        ...
        VLC_EXEC = [r'C:\Program Files\VideoLAN\VLC\vlc.exe', '--no-qt-updates-notif']
